...
export default async function Home() {
  // Only fetch dynamic content: products, projects, testimonials, categories
  const data = await getHomePageData()
  
  // Static hero content
  const heroHeadline = 'Crafting Comfort, Elevating Spaces—Since 2003'
  const heroSubheadline = 'Premium Furniture & Furnishings in Chennai for Homes, Offices, Restaurants & Hotels'
  const trustIndicators = [
    'Over 21 Years of Experience',
    '1000+ Projects Completed',
    '1000+ Satisfied Customers',
  ]
  const brands = ['Molteni', 'Herman Miller', 'Fenix', 'Formica', 'Hettich', 'Daikin']
  const heroVideos = [
    {
  ...
  const videoUrl = 'https://cdn.coverr.co/videos/coverr-modern-living-room-1574/1080p.mp4'
