...
export function Footer({ logoUrl }: { logoUrl?: string | null }) {
  ...
  return (
    <footer className="grainy-gradient text-primary-100 mt-4 mx-4 md:mx-6 lg:mx-8 mb-[8px] rounded-3xl overflow-hidden shadow-[0_18px_50px_rgba(0,0,0,0.18)] relative">
      <Container>
