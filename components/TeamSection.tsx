              ...
              <div className={`flex-1 text-center ${index % 2 === 1 ? 'md:text-right' : 'md:text-left'}`}>
                ...
                <div className={`flex gap-3 justify-center ${index % 2 === 1 ? 'md:justify-end' : 'md:justify-start'}`}>
                  {member.socials.linkedin && (
                    <a href={member.socials.linkedin} className="p-2 bg-white/10 rounded-full text-white hover:bg-white hover:text-primary-900 transition-colors shadow-sm border border-white/10">
                  ...
                  {member.socials.twitter && (
                    <a href={member.socials.twitter} className="p-2 bg-white/10 rounded-full text-white hover:bg-white hover:text-primary-900 transition-colors shadow-sm border border-white/10">
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  {member.socials.instagram && (
                    <a href={member.socials.instagram} className="p-2 bg-white/10 rounded-full text-white hover:bg-white hover:text-primary-900 transition-colors shadow-sm border border-white/10">
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
