  ...
  return (
    <Section className="bg-primary-50" containerSize="2xl">
      <div className="mb-10 text-center">
        <h2 className="font-serif text-4xl md:text-6xl font-bold text-primary-950 tracking-tight">Our Process</h2>
        <p className="text-primary-700 text-lg md:text-xl mt-3">Concierge service from idea to installation</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {steps.map((step, idx) => (
          <Reveal key={step.title} delay={idx * 80} className="h-full">
