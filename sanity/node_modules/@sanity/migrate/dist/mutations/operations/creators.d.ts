...
import { type DecOp, type DiffMatchPatchOp, type IncOp, type IndexedSegment, type InsertOp, type KeyedSegment, type RelativePosition, type ReplaceOp, type SetIfMissingOp, type SetOp, type TruncateOp, type UnsetOp } from './types.js';
/**
